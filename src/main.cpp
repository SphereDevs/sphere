...
const string strMessageMagic = "Sphere Signed Message:\n";
...
//block height for smooth halving
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if(pindexBest->nHeight < 360)
    {   
        nSubsidy = 180 * COIN;
    }
    else if(pindexBest->nHeight < 1080)
    {   
        nSubsidy = 90 * COIN;
    }   
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
   ...
   //pos Superblocks 
   // Yes this if statement is retarded and skips certian blocks, but keep as is to maintain existing chain
    if(pindexBest->nHeight < 4100 && pindexBest->nHeight > 3600)
    {
    nSubsidy = 3600 * COIN;
    }

    else if(pindexBest->nHeight < 5000 && pindexBest->nHeight > 4101)
    {
    nSubsidy = 360 * COIN;
    }

    else if(pindexBest->nHeight < 12502 && pindexBest->nHeight > 5001)
    {
    nSubsidy = 36 * COIN;
    } 
    else if(pindexBest->nHeight < 125001 && pindexBest->nHeight > 12501 )
    {
    nSubsidy = 3.6 * COIN;
    }
...
{
    int64_t ret = blockValue * 0.7331; //73.31%
