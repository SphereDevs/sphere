...
int nAnonymizeSphereAmount = 500;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Sphere
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Sphere
    // Mac: ~/Library/Application Support/Sphere
    // Unix: ~/.sphere
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Sphere";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "sphere.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "sphered.pid"));
